...
if ($_POST['submit']) {
    ...
    $stmt->execute();
    echo "<script>alert('Los detalles del administrador se han actualizado correctamente');</script>";
}
...
<head>
    ...
    <title>Editar Detalles del Administrador</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2 class="page-title">Editar Detalles del Administrador</h2>
