...
if (isset($_POST['submit'])) { // Verifica si 'submit' está definido
    ...
    $query = "UPDATE registration SET confirmada=? WHERE id=?";
    $stmt = $mysqli->prepare($query);
    $stmt->bind_param('ii', $confirmada, $id);
    $stmt->execute();
    echo "<script>alert('El estado de confirmación se ha actualizado correctamente');</script>";
}
?>
...
<head>
    ...
    <title>Confirmar reservaciones</title>
    ...
    <div class="ts-main-content">
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="page-title">Editar Estado de Confirmación</h2>
                        <div class="panel panel-default">
                            <div class="panel-heading">Detalles de la Reservación</div>
                            <div class="panel-body">
                                <form method="post" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" value="<?php echo $row->roomno; ?>" class="form-control"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" value="<?php echo $row->feespm; ?>" class="form-control"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" value="<?php echo $row->foodstatus; ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" value="<?php echo $row->stayfrom; ?>"
                                                class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" value="<?php echo $row->duration; ?>"
                                                class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" value="<?php echo $row->emailid; ?>" class="form-control"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" value="<?php echo $row->codigo_alfanumerico; ?>"
                                                class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
