...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO registration (
        roomno, seater, feespm, foodstatus, stayfrom, duration, firstName, middleName, lastName, gender, contactno, 
        emailid, egycontactno, guardianName, guardianRelation, guardianContactno, corresAddress, corresCIty, 
        corresState, corresPincode, pmntAddress, pmntCity, pmnatetState, pmntPincode, codigo_alfanumerico
    ) VALUES (
        ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?
    )";
    ...
    if ($stmt) {
        $stmt->bind_param(
            'iiiisisissssisississsisss',
            $roomno, $seater, $feespm, $foodstatus, $stayfrom, $duration, $fname, $mname, $lname, $gender, $contactno, 
            $emailid, $emcntno, $gurname, $gurrelation, $gurcntno, $caddress, $ccity, $cstate, $cpincode, 
            $paddress, $pcity, $pstate, $ppincode, $random_code
        );
        ...
        echo "<script>alert('Error en la preparación de la consulta: " . $mysqli->error . "');</script>";
    }
}
?>
							...
							?>
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label">
                                                    <h4 style="color: green" align="left">Información relacionada con la
                                                        habitación </h4>
                                                </label>
                                            </div>
...
?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    Sin Desayuno
                                                    <input type="radio" value="1" name="foodstatus"> Con comida 200
                                                    por mes extra
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">
                                                    <h4 style="color: green" align="left">Información Personal </h4>
                                                </label>
                                            </div>
	 ...
	 //$cnt=1;
	   while($row=$res->fetch_object())
	  {
	  	?>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Nombre de Contacto de Emergencia :
                                                </label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Relación Contacto de Emergencia :
                                                </label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Teléfono Contacto de Emergencia :
                                                </label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">
                                                    <h4 style="color: green" align="left">Dirección de Correspondencia
                                                    </h4>
                                                </label>
                                            </div>
...
?>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">
                                                    <h4 style="color: green" align="left">Dirección Permanente </h4>
                                                </label>
                                            </div>


                                            <div class="form-group">
                                                <label class="col-sm-5 control-label">Dirección de permanencia es la
                                                    misma que la de correspondencia? </label>
                                                <div class="col-sm-4">
