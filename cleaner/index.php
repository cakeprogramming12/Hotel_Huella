...
$stmt = $mysqli->prepare("SELECT username, email, password, id FROM cleaner WHERE (username=? OR email=?) AND password=?");
    $stmt->bind_param('sss', $username, $username, $password);
    $stmt->execute();
    $stmt->bind_result($username, $email, $hashed_password, $id);
    $rs = $stmt->fetch();
    $_SESSION['id']=$id;
