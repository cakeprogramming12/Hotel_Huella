                            ...
                            <div class="panel-body">
                                <table id="zctb" class="table table-bordered" cellspacing="0" width="100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="4">
                                                <h4>Información relacionada con la habitación</h4>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="6"><b>Fecha de Último Acceso:
                                        ...
                                        <tr>
                                            <td><b>Comida</b></td>
                                            <td>
                                                <?php echo ($row->foodstatus == 0) ? "Sin desayuno" : "Con desayuno"; ?>
                                            </td>
                                        ...
                                        <tr>
                                            <td colspan="6"><b>Costo total:
                                                    <?php echo ($row->foodstatus == 1) ? (($dr * $fpm) + 2000) : ($dr * $fpm); ?>
                                                </b>
                                            </td>
                                        </tr>
                                        <tr>
